...
# Clone Tree
git clone https://github.com/kambium30/android_device_xiaomi_santoni -b arrow-10.0 device/xiaomi/santoni
git clone https://github.com/zhantech/android_kernel_xiaomi_santoni.git -b luuvy-4.9 kernel/xiaomi/msm8937
git clone https://github.com/kambium30/vendor_xiaomi_santoni -b arrow-10.0 vendor/xiaomi
